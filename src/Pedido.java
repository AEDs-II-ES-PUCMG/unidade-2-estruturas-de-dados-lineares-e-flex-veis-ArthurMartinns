...
public class Pedido implements Comparable<Pedido> {
	...
	public ItemDePedido existeNoPedido(Produto produto) {
		...
		itensDePedido.buscarPor(null, itemDePedidoProcurado);
	
		return itemDePedidoProcurado;
	}
	...
	public boolean incluirProduto(Produto novo, int quantidade) {
		...
		if (itemDePedido != null) {
			...
			itensDePedido.inserirFinal(itemDePedido);
			return true;
		}
		return false;
	}
	...
	public double valorFinal() {
		...
		itensDePedido.somarMultiplicacoes(new ItemDePedido(null, quantItensDePedido, valorPedido));
